                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      '¡Bienvenido de nuevo! \nPor favor ingrese las credenciales de acceso.',
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional
                                            .fromSTEB(0.0, 16.0, 0.0, 24.0),
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            final apiLogin = ApiLoginCall();

                                            // Llama a la API y almacena el resultado en 'loginExitoso'
                                            bool loginExitoso =
                                                await apiLogin.call(
                                              username: _model
                                                  .emailAddressFieldTextController
                                            ...
                                            // Si la respuesta es exitosa, navega a la siguiente página
                                            if (loginExitoso) {
                                              
                                              context.goNamed(
                                                'DefinicionEstudios',
                                                extra: <String, dynamic>{
                                                  kTransitionInfoKey: const
                                                      TransitionInfo(
                                                    hasTransition: true,
                                                    transitionType:
                                              ...
                                              QuickAlert.show(
                                                ...
                                                title:
                                                    'UPS Credenciales incorrectas', // Título del cuadro de diálogo
                                                text:
                                                    '! Vuelve a intentarlo ¡', // Mensaje del cuadro de diálogo
                                                autoCloseDuration: const Duration(
                                                    seconds:
                                                        5), // Duración antes de que se cierre automáticamente
                                                showConfirmBtn:
                                                    false, // No mostrar botón de confirmación
                                                // Imagen animada de éxito
                                                customAsset:
